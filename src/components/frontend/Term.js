    ...
    return (
        <div>
            ...
            <p className="paragraph4">
                Acceso y uso del sitio            </p>
            <p className="paragraph5">
                Como condición de su acceso y/o uso del Sitio, usted garantiza que:  </p>
            <ol className="listado">
                <li>toda la información proporcionada por usted en el Sitio es precisa, actual y completa;
                </li>
            ...
            <p className="paragraph5">Usted será el único responsable de su acceso y/o uso del Sitio y sus materiales en este documento.

                Cuando crea una cuenta de usuario y una contraseña, debe tratar dicha información como confidencial y no debe divulgarla a terceros. Nos reservamos el derecho de deshabilitar cualquier cuenta de usuario en cualquier momento, si en nuestra opinión no ha cumplido con alguna de las disposiciones de estos T&C.
            ...
            <p className="paragraph7">
                Usted acepta y se compromete a no:

                Usar el Sitio para fines ilegales o que no cumplan con las políticas de uso aceptable de cualquier red informática conectada, cualquier estándar de Internet aplicable y cualquier otra ley aplicable;
                Suplantar a cualquier persona o entidad o declarar falsamente o tergiversar su afiliación con cualquier persona o entidad;
                Intentar obtener acceso no autorizado o interferir o interrumpir otros sistemas informáticos o redes conectados al Sitio, interferir con la utilización y el disfrute del Sitio por parte de otros, o usar o cargar, de cualquier manera, cualquier software o material que contenga, o que usted tiene motivos para sospechar que contiene virus, componentes dañinos, código malicioso o componentes dañinos que pueden dañar o corromper los datos del Sitio o dañar o interferir con el funcionamiento de la computadora o dispositivo móvil de otro cliente o el Sitio; y
                Publicar, promocionar o transmitir a través del Sitio cualquier información, gráficos, fotografías, datos y/o cualquier otro material que contenga algún virus informático u otro código, programa o macro invasivo o dañino; infrinja cualquier propiedad intelectual de terceros o cualquier otro derecho de propiedad; es difamatorio, calumnioso o amenazante; es obsceno, pornográfico, indecente, falsificado, fraudulento, robado, dañino o ilegal de cualquier otro modo según cualquier ley aplicable; y/o es o puede ser interpretado como ofensivo y/o objetable, en nuestra opinión exclusiva.
            </p>
            ...
            <p className="paragraph8">
                Nuestros sitios web no responden a las señales de
                no rastrear porque no rastreamos a nuestros usuarios
                a lo largo del tiempo y en sitios web de terceros para
                proporcionar publicidad dirigida. Sin embargo, creemos que debe
                tener una opción con respecto a los anuncios basados en intereses publicados
                por nuestros socios, por lo que le describimos las opciones disponibles arriba.
            </p>
            ...
            <p className="paragraph10">
                ...
                Si participa en el programa de fidelización, acepta lo siguiente:

                Sus puntos y recompensas no tienen valor en efectivo y no se pueden canjear por efectivo.
                Debe presentar su código QR personal o dirección de correo electrónico cuando desee acumular puntos.
                Sus puntos y recompensas no se pueden transferir, traer, vender ni intercambiar de ninguna manera.
                Puede consultar sus puntos y recompensas en su cuenta en línea. En caso de discrepancia entre los puntos de membresía reflejados en su cuenta y nuestros registros internos, prevalecerán estos últimos.
                Los puntos ganados y/o canjeados se actualizarán en su cuenta en línea dentro de un período razonable de su transacción.
                Puede usar sus puntos para canjear recompensas solo a través de su cuenta personal en línea. Las recompensas se pueden usar en línea o fuera de línea según se especifica en sus términos y condiciones.
                A menos que se indique lo contrario, se ganan puntos en todas las compras, excepto en las tarjetas de regalo, los códigos de cupón, los créditos de la tienda, los gastos de envío y los gastos de transporte.
                ...
                Su participación continua en el programa confirmará su aceptación de dichos cambios o modificaciones. Por lo tanto, debe revisar estos términos y condiciones y las políticas aplicables con frecuencia para comprender los términos y condiciones que se aplican al programa.
            </p>
            ...
            <p className="paragraph15">
                El Sitio, sus servicios y toda la información proporcionada en este documento se proporcionan "tal cual" y "según disponibilidad" sin garantías de ningún tipo, ya sean expresas o implícitas, además de las impuestas por la ley, incluidas, entre otras, las garantías de título. o garantías implícitas de comerciabilidad, calidad satisfactoria, idoneidad para un propósito particular o ausencia de infracción.

                Sin limitar la generalidad de lo anterior, renunciamos expresamente a cualquier garantía, condición, término o representación (i) en cuanto a la confiabilidad, precisión, integridad y validez de cualquier contenido o material en el Sitio; (ii) que las funciones contenidas en el Sitio serán seguras, ininterrumpidas o libres de errores; y (iii) que cualquier defecto será corregido. Todas y cada una de dichas garantías, condiciones, términos y representaciones están específicamente excluidas. No asumimos ninguna responsabilidad por errores u omisiones en los materiales del Sitio, incluidas las inexactitudes de hecho o de otro tipo o los errores tipográficos. Usted acepta expresamente que su uso y/o acceso al Sitio es bajo su propio riesgo.
            ...
            <p className="paragraph17">
                Usted acepta indemnizarnos y eximirnos a nosotros y a nuestros socios, afiliados, subsidiarias, agencias de publicidad, agentes y sus empleados, funcionarios, directores y representantes de cualquier reclamo, pérdida y daño, incluidos los honorarios razonables de los abogados, que surjan de:

                Su acceso, uso y/o participación en este Sitio;
                Incumplimiento de sus obligaciones en virtud de estos T&C;
                Su violación de cualquier derecho de otra persona o entidad; y/o
                Su incumplimiento de cualquier requisito legal, deber o ley.
            </p>
            ...
            <p className="paragraph17">
                Determinaremos, a nuestro exclusivo criterio, si ha habido un incumplimiento de estos T&C a través de su uso y/o acceso al Sitio. Cuando se ha producido un incumplimiento de estos T&C, podemos tomar las medidas que consideremos apropiadas, que incluyen:

                Retiro inmediato, temporal o permanente de su derecho de uso y/o acceso al Sitio;
                Emitirle una advertencia;
                Renunciar a los puntos que ha acumulado en el programa de fidelización;
                Iniciar procedimientos legales en su contra por pérdidas resultantes de su incumplimiento; y
                Divulgación a las autoridades encargadas de hacer cumplir la ley de la información que razonablemente consideremos necesaria.
                Excluimos la responsabilidad por cualquier acción tomada en respuesta al incumplimiento de estos T&C. Las respuestas descritas anteriormente no son exhaustivas, y podemos tomar cualquier otra acción que razonablemente consideremos apropiada.
            </p>
            ...
            <p className="paragraph20">
                Puede realizar un pedido con nosotros completando y enviando el formulario de pedido en el Sitio. Usted será responsable de garantizar la exactitud de todos los pedidos. Todos los pedidos se considerarán irrevocables e incondicionales tras la transmisión a través del Sitio, y tendremos el derecho, pero no la obligación, de procesar dichos pedidos sin su consentimiento adicional y cualquier otra referencia o aviso para usted.

                Nos reservamos el derecho de aceptar o rechazar cualquiera y todos los pedidos recibidos desde o a través del Sitio a nuestra única y absoluta discreción. Nuestra aceptación de su pedido tendrá lugar cuando se envíe un correo electrónico de confirmación a su dirección de correo electrónico registrada con nosotros, momento en el que se establecerá un contrato entre usted y nosotros. Cada pedido completamente pagado que aceptemos constituirá un contrato separado e individual regido por estos T&C (un "Pedido"). Le asignaremos un número de pedido a su Pedido cuando lo aceptemos. Díganos el número de pedido cada vez que se comunique con nosotros acerca de su Pedido.

                Si no podemos procesar su pedido, se lo informaremos. Esto puede deberse a que el producto está agotado, debido a límites inesperados en nuestros recursos que no pudimos planificar razonablemente, porque una referencia de crédito que hemos obtenido para usted no cumple con nuestros requisitos mínimos, porque hemos identificado un error en el precio o descripción del producto, o porque no podemos cumplir con el plazo de entrega que ha especificado.

                El precio que debe pagar por el producto será el precio del producto listado para la venta como se indica en el Sitio en el momento en que nos transmite su pedido a través del Sitio, más los impuestos aplicables. Todos los precios están sujetos a impuestos, a menos que se indique lo contrario. Nos reservamos el derecho de modificar el precio de cualquier producto en cualquier momento sin dar ningún motivo ni previo aviso. Complete el pago en el momento en que realizó su pedido, ya que todos los pedidos sin pagar se cancelarán automáticamente después de una hora. Siempre es posible que, a pesar de nuestros mejores esfuerzos, algunos de los productos que vendemos tengan un precio incorrecto. Normalmente comprobaremos los precios antes de aceptar su pedido, de modo que, cuando el precio correcto del producto en la fecha de su pedido sea inferior al precio indicado en la fecha de su pedido, le cobraremos el importe más bajo. Si el precio correcto del producto en la fecha de su pedido es más alto que el precio que se le indicó, nos pondremos en contacto con usted para recibir instrucciones antes de entregar su pedido.

                Aceptamos todas las principales tarjetas de crédito y PayPal.

            </p>
            <p className="paragraph19">
                Descripción del producto y defectos            </p>
            ...
            <p className="paragraph19">
                Devoluciones            </p>
            <p className="paragraph17">
                Aceptamos devoluciones de artículos* sin usar, sin lavar, sin alterar y con sus etiquetas intactas.

                *La compra de artículos en oferta, ropa interior, trajes de baño, accesorios y bolsos es definitiva y no se puede devolver ni cambiar.



                Para iniciar una solicitud de devolución, por favor:

                Rellene la nota de devolución, puede descargar una copia aquí.
                Embale el artículo y su nota de devolución completa en su material de embalaje original
                Envíe su paquete utilizando un método de entrega que permita el seguimiento. Los paquetes devueltos deben llegar a nosotros dentro de los 30 días calendario a partir de la fecha de envío para pedidos locales, o 45 días calendario para pedidos internacionales.
                Usted es responsable de los gastos de envío de los artículos devueltos. Tenga en cuenta que todos los paquetes devueltos se tratan solo por correo. Si devuelve un artículo que no cumple con los requisitos para devoluciones establecidos anteriormente, nos reservamos el derecho de rechazar la devolución y cualquier solicitud de reembolso de crédito de la tienda. Usted es responsable del artículo hasta que nos llegue y tenga la amabilidad de conservar todas las pruebas de envío hasta que se haya enviado un acuse de recibo.

                Si aceptamos su devolución, haremos los reembolsos que se le adeuden lo antes posible y, en general, dentro de los 14 días a partir del día en que recibimos el producto devuelto. Tenga en cuenta que los reembolsos se proporcionarán solo en forma de crédito de la tienda.</p>
            ...
            <p className="paragraph17">
                El costo de la entrega de su Pedido se le mostrará en nuestro Sitio. Ofrecemos envíos internacionales y puede consultar nuestras preguntas frecuentes para obtener más detalles.

                Los pedidos se procesan y envían desde nuestro almacén a nuestro socio de entrega local en un plazo estimado de 2 días hábiles. Nuestro socio de entrega local entregará el producto a la dirección especificada en su Pedido. Las fechas de entrega indicadas durante el proceso de pedido son solo estimaciones.

                Si la entrega de su producto se retrasa, le informaremos en consecuencia y el producto se enviará una vez que esté disponible. El tiempo de entrega no será esencial, y ni nosotros ni nuestros agentes seremos responsables de ningún retraso en la entrega, cualquiera que sea su causa.</p>
                <p className="paragraph19">
                Paquetes rebotados       </p>
...
<p className="paragraph19">
Cuando te haces responsable del producto       </p>

<p className="paragraph17">
El producto será tu responsabilidad desde el momento en que te entreguemos el producto en la dirección que nos hayas facilitado. Usted es el propietario del producto objeto de su Pedido una vez que hayamos recibido el pago total de su Pedido.</p>

<p className="paragraph19">
Terminación  </p>

<p className="paragraph17">
Podemos rescindir el Pedido en cualquier momento escribiéndote si:

Usted no nos hace el pago cuando vence;
Usted no nos proporciona, dentro de un tiempo razonable después de que lo solicitemos, la información necesaria para que le proporcionemos el producto (por ejemplo, la dirección de entrega);
Usted no nos permite, dentro de un tiempo razonable, entregarle el producto;
Si rescindimos el Pedido en las situaciones establecidas anteriormente, le reembolsaremos cualquier dinero que haya pagado por adelantado por productos que no le hayamos proporcionado, pero podemos deducir o cobrarle una compensación razonable por los costos netos en los que incurriremos como resultado de su rompiendo el contrato.</p>
...
Resolución de disputas: Cualquier disputa que surja de o en relación con este contrato, incluida cualquier pregunta sobre su existencia, validez o terminación, se remitirá y se resolverá finalmente mediante arbitraje administrado por el Centro de Arbitraje Internacional de Singapur ("SIAC") de acuerdo con las Reglas de Arbitraje del Centro de Arbitraje Internacional de Singapur ("Reglas SIAC") actualmente en vigor, reglas que se consideran incorporadas por referencia en esta cláusula. La sede del arbitraje será Singapur. El Tribunal estará compuesto por 1 árbitro. El idioma del arbitraje será el inglés.</p>    


<p className="paragraph19">
Acuerdo de uso de imágenes </p>

<p className="paragraph17">
Estimada #LBCommunity,
...
<p className="paragraph17">
Las tarjetas de regalo son válidas por un año y son estrictamente no reembolsables y no extensibles. Las tarjetas de regalo se pueden canjear en múltiples transacciones, hasta que su valor se haya utilizado por completo.</p>     


<p className="paragraph19">
Notas adicionales </p>
<p className="paragraph17">
Si no recibió una nota de devolución, haga clic aquí para descargar una copia. Nos pondremos en contacto dentro de una semana a partir de la fecha en que recibamos su artículo devuelto. El crédito de la tienda se emitirá tras una solicitud de devolución procesada con éxito.</p>     
...
<p className="paragraph17">
Podemos cambiar cualquier contenido o material en el Sitio en cualquier momento. Cualquier parte del contenido o material del Sitio puede estar desactualizado en un momento dado, y no tenemos ninguna obligación de actualizar el Sitio. No seremos responsables si por alguna razón el Sitio, o cualquier parte del mismo, no está disponible en algún momento o durante algún período. Nos reservamos el derecho de rechazar cualquier acceso actual o futuro y/o uso del Sitio sin previo aviso.
